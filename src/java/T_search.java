 ...
 * @author Rajendra
 */
public class T_search extends HttpServlet {
...
catch(Exception ex1)
{
	System.out.println(ex1);
        ...
        student+="<div class=\"container\"  style=\"margin-top: -20px; padding:0px; text-align: center; border: solid 1px ; border-radius: 15px;\"><p>";
           student+=a;
           student+="</p></div>";
            student+="<div class=\"container\" id=\"sreg\" style=\"margin-top: 1px; padding: 0px;\">\n";
            student+="<div class=\"container\"id=\"maindiv\" >\n";
            student+="<h2> Teacher Record Update </h2>\n";
            student+="<form action=\"T_update\" method=\"post\">\n";
