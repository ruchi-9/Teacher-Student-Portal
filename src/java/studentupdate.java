...
"                <h2> Student Record Updation </h2>\n" +
"            <form action=\"s_record\" method=\"post\">\n" +
"                <table class=\"table table-hover\"  >\n" +
"                            <th scope=\"row\">Enter Student Id: </th>\n" +
"                            <td><input type=\"text\"  name=\"ID\"pattern=\"[1]+[0-5]+(EBK|ebk)+(cs|CS|ec|EC|ee|EE|ex|EX)+[0-9]{1,3}\" required=\"enter Student id\" /> </td>\n" +
"                          </tr>\n" +
"                    </tbody>\n" +
"                </table>\n" +
