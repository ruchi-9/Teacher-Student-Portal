 ...
 * @author Beniwal
 */
public class trecorddefine extends HttpServlet {
         ...
         }catch(Exception cc)
         {
	         ...
	         Cookie[] cookies = null;
                 ...
                 //  try{System.out.print(sub[6]);}catch(Exception e){system.out.println("");}
                   ...
                   while(i!=6&&!(sub[i].trim()).equals(null))
                   {
                   try
                   {
                      ps1=con.prepareStatement("select * from t_rest where id = ? and code=?");
                      ps1.setString(1, tid);
...
"<html>\n";
                   ...
                   output+=a;
                   output+="</p></div>";
                    output+="<div class=\"container\" id=\"sregt\" >\n";
                    }
                   else{
                     output+="<div class=\"container\" id=\"sreg\">\n";
                   }output+="<div class=\"container\" id=\"maindiv\">\n" +
"                <h2 style=\"color: black ;font-variant:small-caps; font-style:normal; \"> Teacher Record Define </h2>\n" +
"            <form action=\"tsubdefine\" method=\"post\">\n" +
"                <table class=\"table \"  >\n" +
"                    <tbody>\n" +
"                          <tr> \n" +
